...
namespace FIT_Api_Examples.Modul1_TestniPodaci.Controllers
{
    ...
    public class TestniPodaciController : ControllerBase
    {
        ...
        {
            //kreirane liste koje cuvaju podatke prije no se dodaju u bp
            ...
            //opstine povezane s državama jer imaju strani kljuc na drzavu / objekat drzava povezan s nekim objektom u listi drzave
           ...
           //Random rnd = new Random(); //ostala greška

            for (int i = 0; i <100; i++) //generisanje 100 studenata 
            {
            ...
            //komanda add range dodaje podatke u db_context
            ...
            _dbContext.SaveChanges(); //saveChanges izvršava query, ono sto je ranije pripremljeno

            return Count(); //poziv funkcije s vrha
        }
    }
}